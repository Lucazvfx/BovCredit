...
def _conceitos() -> dict:
    ...
    return {
        ...
        'custo': (
            ...
            'uma constante.\n\n'
            'A comparação é COE contra COE: custo de DESEMBOLSO, incluindo a '
            'compra de animais, sem depreciação nem remuneração do capital — '
            'esses dois são COT e CT, e misturá-los inflaria o nosso lado.\n\n'
            'Comparar em CT parece mais rigoroso e seria erro grave. O painel '
            'do Pantanal de Corumbá publica os três para a mesma fazenda '
            'modal: receita R$ 275,32/@, COE R$ 223,21/@, COT R$ 260,76/@, '
            'CT R$ 431,09/@ — positiva nos dois primeiros, prejuízo de R$ 1,66 '
            'milhão no terceiro. Em mais de 90% das fazendas brasileiras a '
            'receita não remunera o capital investido, porque o ativo é a '
            'TERRA e a valorização dela não entra na receita do ano. Quem '
            'comparasse em CT reprovaria nove em cada dez. Crédito se paga '
            'com caixa, e COE é o nível do caixa.\n\n'
            'A referência é a FAIXA entre os painéis Campo Futuro/CNA da '
            'modalidade, não um ponto: a mesma metodologia dá R$ 189,76/@ na '
            'cria de Altamira/PA e R$ 166,35/@ na de Pelotas/RS. Quem fica entre '
            'os dois não está fora de lugar nenhum. Cita-se o painel da praça '
            'mais próxima, mas a faixa é a mesma para todo mundo.\n\n'
            f'Só o que passa do TETO da faixa conta, e acima de '
            f'{COE_DIVERGENCIA_AVISO:.0f}% aparece no parecer como aviso: se o '
            'custo estiver superestimado, a geração de caixa e o DSCR estão '
            'subestimados na mesma proporção. É para o analista conferir antes '
            'de aceitar uma recusa.'
        ),
        'carencia': (
